...
def cspdarknet53(input_data):
    ...
    input_data = tf.concat([tf.nn.max_pool2d(input_data, ksize=13, padding='SAME', strides=1), tf.nn.max_pool2d(input_data, ksize=9, padding='SAME', strides=1)
                            , tf.nn.max_pool2d(input_data, ksize=5, padding='SAME', strides=1), input_data], axis=-1)
